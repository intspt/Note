...
from config import ERROR, EMPTY_ERROR, LOGIN_INFO_ERROR, INDEX_NOTE_NUM, \
                        CATALOG_NOTE_NUM
...
def home():
    ...
    note_list = Note.query.filter_by(is_visible=True).order_by('notes.time_ DESC').paginate(pn, \
                                                        INDEX_NOTE_NUM)
